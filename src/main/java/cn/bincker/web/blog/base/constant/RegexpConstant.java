...
public class RegexpConstant {
     ...
     * 匹配用户名
     */
    public static final String USERNAME_VALUE = "^[_.\\-\\w\\u4e00-\\u9fa5]{5,16}$";
    public static final Pattern USERNAME = Pattern.compile(USERNAME_VALUE);
     ...
     * 手机号
     */
    public static final String PHONE_NUM_VALUE = "^1(3\\d|4[5-9]|5[0-35-9]|6[567]|7[0-8]|8\\d|9[0-35-9])\\d{8}$";
    public static final Pattern PHONE_NUM = Pattern.compile(PHONE_NUM_VALUE);
}
